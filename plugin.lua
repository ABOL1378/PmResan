function run(msg)
	...
	about_key = {{{text = "کانال ما" , url = "https://telegram.me/LINK_DONI_TM"}},{{text = "کانال ما" , url = "https://telegram.me/LINK_DONI_TM"}},{{text = "پیام رسان سازنده" , url = "https://telegram.me/oOo_SUDO_Link_Doni_oOo"}},{{text = "سودو وبات ساز" , url = "https://telegram.me/oOo_SUDO_Link_Doni_oOo"}}}
	...
	start_key = {{{text="ساخت ربات پیام رسان",url="https://telegram.me/oOo_SUDO_Link_Doni_oOo"}}}
...
function inline(msg)
	...
	bioinfo = infotxtin.."*Name:* "..sudo_name.."\n*Username:* [@"..sudo_user.."](https://telegram.me/"..sudo_user..")\n*Mobile:* +"..sudo_num.."\n*Telegram ID:* "..sudo_id.."\n*Channel:* [@"..sudo_ch.."](https://telegram.me/"..sudo_ch..")\n\n_Powered by_ [ʟɪɴᴋ ᴅᴏɴɪ™](https://telegram.me/LINK_DONI_TM)"
	tabless = '[{"text":"https://telegram.me/oOo_SUDO_Link_Doni_oOo","url":"https://telegram.me/'..sudo_user..'"}],[{"text":"کانال شخصی من","url":"https://telegram.me/'..sudo_ch..'"}],[{"text":"کانال سازنده","url":"https://telegram.me/LINK_DONI_TM"},{"text":"سازنده ربات","url":"https://telegram.me/oOo_SUDO_Link_Doni_oOo"}]'
